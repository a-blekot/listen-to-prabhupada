        ...
        listOf(
            ...
            it.binaries {
                framework {
                    ...
                    export(project(":common:feature-favorites-api"))
                    export(project(":common:feature-downloads-api"))
    ...
    sourceSets {
        commonMain {
            dependencies {
                ...
                implementation(project(":common:feature-favorites-impl"))
                implementation(project(":common:feature-downloads-api"))
                implementation(project(":common:feature-downloads-impl"))
    ...
    sourceSets {
        findByName("iosMain")?.run  {
            dependencies {
                ...
                api(project(":common:feature-favorites-api"))
